...
(() => {
  ...
  function load() {
    ...
    // Under file:// (e.g. a downloaded standalone copy) a fetch of the
    // relative sidecar is blocked by CORS and logs a noisy error. There's
    // no host bridge there anyway, so skip straight to the src fallbacks.
